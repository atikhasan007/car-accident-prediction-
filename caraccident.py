...
import pickle
# মডেল লোড
pipe = pickle.load(open("car-accident-prediction-/10 pipe.pkl", 'rb'))

# Streamlit অ্যাপ
st.title("Accident Prediction with Pipeline")

# সরাসরি ছবি পাথ ব্যবহার করে লোড করো
st.image("car-accident-prediction-/10 pipe img.png", caption="Prediction Pipeline", use_container_width=True)
